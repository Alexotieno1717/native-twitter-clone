  ...
  const ProfileHeader = () => (
    <View style={styles.container}>
      ...
      <View style={styles.nameContainer}>
        <Text style={styles.profileName}>Alex Otieno</Text>
        <Text style={styles.profileHandle}>@Alexoiteno900</Text>
      </View>
      ...
      <View style={styles.linkContainer}>
        <TouchableOpacity
          ...
          onPress={() => Linking.openURL("https://alexotieno.vercel.app")}
        >
          <EvilIcons name="link" size={24} color="gray" />
          <Text style={styles.linkColor}>Alexotieno.dev</Text>
        </TouchableOpacity>
